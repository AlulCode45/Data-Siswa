...
<head>
    ...
    <title>@yield('title') - Aplikasi DataSiswa SMKN 4 Bojonegoro</title>
    ...
    <script>
        function getLink() {
            ...
            alert("Copy link sukses : " + copyText.value);
        }
    </script>
...
<body>
    ...
    <footer id="footer" class="footer">
        <div class="copyright">
            &copy; Copyright <strong><span>AlulCode</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
