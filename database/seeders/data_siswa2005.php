...
class data_siswa2005 extends Seeder
{
    /**
    ...
    public function run()
    {
        $data = file_get_contents("http://localhost:8000/data2005.json");
        ...
        foreach ($result as $key => $data) {
            $save = [
                ...
                // 'ttl' => (array_key_exists('TEMPAT,', $data)  ? $data['TEMPAT,'] : null) . ", " . (array_key_exists('TANGGAL LAHIR', $data)  ? $data['TANGGAL LAHIR'] : null),
                ...
                // 'no_induk' => (array_key_exists('NOMOR', $data) ? $data['NOMOR'] : null) . (array_key_exists('INDUK', $data) ? $data['INDUK'] : null) . (array_key_exists('INDUK1', $data) ? $data['INDUK1'] : null) . (array_key_exists('INDUK2', $data) ? $data['INDUK2'] : null) . (array_key_exists('INDUK3', $data) ? $data['INDUK3'] : null) . (array_key_exists('INDUK4', $data) ? $data['INDUK4'] : null),
                'no_induk' => (array_key_exists('NOMOR', $data) ? $data['NOMOR'] : null) . (array_key_exists('INDUK', $data) ? $data['INDUK'] : null) . (array_key_exists('INDUK1', $data) ? $data['INDUK1'] : null),
                ...
                'no_sttb' => array_key_exists('NO.STTB', $data)  ? $data['NO.STTB'] : null,
                'tahun_lulus_smp' => array_key_exists('THN', $data)  ? intval($data['THN']) : null,
                'tahun_masuk' => array_key_exists('TAHUN MASUK', $data)  ? intval($data['TAHUN MASUK']) : null,
