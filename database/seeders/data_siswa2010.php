...
class data_siswa2010 extends Seeder
{
    /**
    ...
    public function run()
    {
        $data = file_get_contents("http://localhost:8000/data2010.json");
        ...
        foreach ($result as $key => $data) {
            $save = [
                ...
                'ttl' => (array_key_exists('TEMPAT,', $data)  ? $data['TEMPAT,'] : null) . ", " . (array_key_exists('TTL1', $data)  ? $data['TTL1'] : null),
                ...
                'tahun_lulus_smp' => array_key_exists('THN', $data)  ? intval($data['THN']) : null, 'tahun_masuk' => 2010,
